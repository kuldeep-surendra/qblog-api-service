...
app.get('/api/public', function(req, res) {
  res.json({ message: "Hello sdsdf sdf sdf sdds from a public endpoint! You don't need to be authenticated to see this." });
});

app.get('/api/private', checkJwt, checkScopes, function(req, res) {
  res.json({ message: "Hello sdffds   sdfsdffdsdfs a private endpoint! You need to be authenticated and have a scope of read:messages to see this." });
});
